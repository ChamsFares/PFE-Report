...
\begin{itemize}
    ...
    \item Cisco NDFC: The centralized automation and orchestration solution for the entire underlay and overlay fabric from a single management plane, directly eliminating manual configuration effort, configuration drift, and policy enforcement inconsistencies.
\end{itemize}
